class ErrorCorrector
  def correct(corrupted_data)
    corrupted_data
      .split("\n")
      .map(&:chars)
      .transpose
      .map { |column| most_frequent(column) }
      .join
  end
...
describe ErrorCorrector do
  it "corrects corrupted data" do
    ErrorCorrector.new.correct(<<~INPUT).must_equal "easter"
      eedadn
      drvtee
      eandsr
      raavrd
