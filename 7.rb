class IPv7 < Struct.new(:address)
  AddressParts = Struct.new(:supernet_sequences, :hypernet_sequences)
  ...
  def address_parts
    ...
    parts.each_with_index do |part, index|
      outside << part if index.even?
      inside << part if index.odd?
    end

    AddressParts.new(outside, inside)
  end
...
describe IPv7 do
  it "detects whether the address supports TLS" do
    IPv7.new("abba[mnop]qrst").tls?.must_equal true
    IPv7.new("abcd[bddb]xyyx").tls?.must_equal false
    IPv7.new("aaaa[qwer]tyui").tls?.must_equal false
  ...
  it "deconstructs an address" do
    ...
    result.supernet_sequences.must_equal %w[aaa ccc eee ggg]
    result.hypernet_sequences.must_equal %w[bbb ddd fff]
  end
end
